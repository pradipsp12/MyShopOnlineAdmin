...
class VariantsListSection extends StatelessWidget {
  ...
  Widget _buildShimmerEffect({
    ...
    final variantColumnWidth = screenWidth * (isMobile ? 0.3 : 0.25);
    final typeColumnWidth = screenWidth * (isMobile ? 0.2 : 0.15);
    final dateColumnWidth = screenWidth * (isMobile ? 0.2 : 0.15);
    final actionColumnWidth = screenWidth * (isMobile ? 0.1 : 0.08);
    final totalTableWidth = variantColumnWidth + typeColumnWidth + dateColumnWidth + 
                          (actionColumnWidth * 2) + (columnSpacing * 4);
        ...
        child: SingleChildScrollView(
          ...
          child: SizedBox(
            ...
            child: DataTable(
              ...
              columns: [
                DataColumn(label: _buildShimmerCell(variantColumnWidth)),
                  ...
                  cells: [
                    DataCell(Row(
                      children: [
                        ...
                        _buildShimmerCell(variantColumnWidth - 24 - columnSpacing, height: 16),
                      ],
                    )),
  ...
  Widget _buildDataTable(BuildContext context, BoxConstraints constraints, double columnSpacing, DataProvider dataProvider) {
    ...
    return ConstrainedBox(
      ...
      child: DataTable(
        ...
        columns: [
          DataColumn(label: Text("Variant", style: TextStyle(fontSize: isMobile ? 12 : 14))),
          DataColumn(label: Text("V-Type", style: TextStyle(fontSize: isMobile ? 12 : 14))),
