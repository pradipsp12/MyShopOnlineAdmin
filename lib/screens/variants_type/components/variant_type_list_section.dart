...
class VariantsTypeListSection extends StatelessWidget {
  ...
  Widget _buildShimmerEffect({
    ...
    final nameColumnWidth = screenWidth * (isMobile ? 0.3 : 0.25);
    ...
    final totalTableWidth = nameColumnWidth + typeColumnWidth + dateColumnWidth + 
        ...
        child: SingleChildScrollView(
          ...
          child: SizedBox(
            ...
            child: DataTable(
              ...
              columns: [
                DataColumn(label: _buildShimmerCell(nameColumnWidth)),
                  ...
                  cells: [
                    DataCell(Row(
                      children: [
                        ...
                        _buildShimmerCell(nameColumnWidth - 24 - columnSpacing, height: 16),
                      ],
                    )),
